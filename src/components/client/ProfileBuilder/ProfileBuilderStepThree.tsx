...
export const ProfileBuilderStepThree: React.FC<ProfileBuilderStepThreeProps> = ({
  ...
  const movementOptions: MovementOption[] = [
    ...
    { label: 'Yoga', icon: <Activity className="h-5 w-5" /> },
    { label: 'Dance', icon: <Music className="h-5 w-5" /> },
    { label: 'Hiking', icon: <Mountain className="h-5 w-5" /> },
    { label: 'Basketball', icon: <Activity className="h-5 w-5" /> },
    { label: 'Soccer', icon: <Activity className="h-5 w-5" /> },
    { label: 'Tennis', icon: <Activity className="h-5 w-5" /> },
    ...
    { label: 'Skiing', icon: <Activity className="h-5 w-5" /> },
    ...
    { label: 'Golf', icon: <Activity className="h-5 w-5" /> },
    { label: 'Boxing', icon: <Activity className="h-5 w-5" /> },
