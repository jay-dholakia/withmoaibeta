...
import { StandaloneWorkout, SupersetGroup } from '@/types/workout';
import { DumbbellIcon, Clock, RotateCw } from 'lucide-react';

interface StandaloneWorkoutViewProps {
  workout: StandaloneWorkout;
  supersetGroups?: SupersetGroup[];
}

const StandaloneWorkoutView: React.FC<StandaloneWorkoutViewProps> = ({ workout, supersetGroups = [] }) => {
...
export default StandaloneWorkoutView;
